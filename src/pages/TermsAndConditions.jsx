...
const TermsAndConditions = () => {
  return (
    <div className="container mx-auto p-8">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">3. Loan Services</h2>
      <ul className="list-disc list-inside mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">4. Insurance Services</h2>
      <ul className="list-disc list-inside mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">5. Fees and Charges</h2>
      <ul className="list-disc list-inside mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">6. Privacy and Data Protection</h2>
      <ul className="list-disc list-inside mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">7. Customer Responsibilities</h2>
      <ul className="list-disc list-inside mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">9. Amendments</h2>
      <ul className="list-disc list-inside mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">10. Governing Law and Jurisdiction</h2>
      <ul className="list-disc list-inside mb-4">
